...
router.get(
  ...
  asyncHandler(async (req, res) => {
    ...
    let q = supabaseAdmin
      .from('boutiques')
      .select('id, name, slug, description, logo_url, logo_initials, logo_bg, address, city_id, rating, review_count, follower_count, primary_category, category_tags, style_tags, price_tier, status, campaign_images', { count: 'exact' })
